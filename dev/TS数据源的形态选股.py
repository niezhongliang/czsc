...
# import tushare as ts
# ts.set_token("d18845e7180908b356f4488686e5767706aa8651d9c737d39d925156")
...
def get_events_matched(refresh=False):
    ...
    events = [
        {
            ...
            "factors": [{"name": "CCI看多", "signals_all": ["周线_D1CCI14#3#10_BS辅助V230402_多头_任意_任意_0"]}],
        },
    ...
    ems_params = {
        ...
        "edt": "2024-11-13",
        "max_workers": 10,
        "results_path": r"/Users/niez01/Documents/dev/czsc/results",
    }
